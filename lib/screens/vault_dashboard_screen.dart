...
class _VaultDashboardScreenState extends State<VaultDashboardScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content:
                Text(success ? 'Vault imported successfully' : 'Import failed'),
  ...
  Future<void> _revealDetail(VaultInfo vault) async {
    final password = await _askPassword(
        'Reveal Details', 'Enter password to reveal vault details:');
  ...
  Future<void> _exportVault(VaultInfo vault) async {
    final password =
        await _askPassword('Export Vault', 'Enter password to export vault:');
    if (password == null) return;
        ...
        floatingActionButton: Row(
          ...
          children: [
            ...
            if (widget.registry.canAddVault &&
                widget.registry.vaults.isNotEmpty)
              Container(
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(16),
                  boxShadow: [
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: isRevealing
                                ? null
                                : (isRevealed ? onHideDetail : onRevealDetail),
                            tooltip:
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                      color: CyberpunkTheme.warning.withOpacity(0.3)),
                ),
                child: Row(
                  children: [
                    const Icon(Icons.warning_amber,
                        color: CyberpunkTheme.warning, size: 20),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Text(
                    ...
                    children: [
                      ...
                      _isProcessing
                          ...
                          : Switch(
                              ...
                              inactiveTrackColor:
                                  CyberpunkTheme.warning.withOpacity(0.3),
                            ),
                    ],
                  ),
                );
...
class _SecureKeyboardWarningDialog extends StatefulWidget {
  ...
  @override
  State<_SecureKeyboardWarningDialog> createState() =>
      _SecureKeyboardWarningDialogState();
}

class _SecureKeyboardWarningDialogState
    extends State<_SecureKeyboardWarningDialog> {
      ...
      actions: [
        ...
        TextButton(
          ...
          child: Text(
            ...
            style: TextStyle(
              color:
                  _confirmed ? CyberpunkTheme.warning : CyberpunkTheme.textHint,
              fontWeight: FontWeight.bold,
            ),
          ),
        ),
