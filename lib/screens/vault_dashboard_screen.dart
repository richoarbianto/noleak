...
class _VaultDashboardScreenState extends State<VaultDashboardScreen> {
  ...
  final Map<String, Map<String, dynamic>> _revealedKdfParams = {};
  ...
  void _wipeRevealedDetail(String vaultId) {
    if (_revealedDetails.containsKey(vaultId)) {
      ...
      _revealedKdfParams.remove(vaultId);
    }
  }
  ...
  Future<void> _revealDetail(VaultInfo vault) async {
    ...
    try {
      ...
      final kdfParams = await VaultChannel.getVaultKdfParams();
      ...
      if (mounted) {
        setState(() {
          ...
          if (kdfParams != null) {
            _revealedKdfParams[vault.id] = kdfParams;
          }
        });
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _VaultCard(
                ...
                revealedKdfParams: isRevealed ? _revealedKdfParams[vault.id] : null,
...
class _VaultCard extends StatelessWidget {
  ...
  final Map<String, dynamic>? revealedKdfParams;
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      // KDF params when revealed
                      if (isRevealed && revealedKdfParams != null) ...[
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: _getProfileColor(revealedKdfParams!['profile'] as String? ?? '').withOpacity(0.15),
                                borderRadius: BorderRadius.circular(4),
                                border: Border.all(
                                  color: _getProfileColor(revealedKdfParams!['profile'] as String? ?? '').withOpacity(0.4),
                                ),
                              ),
                              child: Text(
                                revealedKdfParams!['profile'] as String? ?? 'UNKNOWN',
                                style: TextStyle(
                                  color: _getProfileColor(revealedKdfParams!['profile'] as String? ?? ''),
                                  fontSize: 9,
                                  fontWeight: FontWeight.bold,
                                ),
                              ),
                            ...
                            Text(
                              '${revealedKdfParams!['memoryMb']}MB • ${revealedKdfParams!['iterations']} iter',
                              style: TextStyle(
