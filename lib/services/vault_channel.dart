...
class VaultChannel {
  ...
  /// Returns map with: memoryMb, iterations, parallelism, profile, deviceRamMb
  ...
  static Future<Map<String, dynamic>?> getVaultKdfParams() async {
    try {
      final result = await _channel.invokeMethod<Map>('getVaultKdfParams');
      return result != null ? Map<String, dynamic>.from(result) : null;
    } on PlatformException {
      return null;
    }
