...
NoLeak is an Android-only project under active development. The current application version is `1.0.3` (`versionCode 1003`) and requires Android 7.0/API 24 or newer.
